...
if ( $r <= 5 )
{
    ...
    $game_skill_text[12][4][1] = "[<b>{$target_name}</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>{$player_name} </b>нанес{$sex_a} silniy удар топором в <font class=atype>область шеи </font> {$sopernika2}.";

...
{
    $game_skill_dmg[11][4] = 1;
    $game_skill_textnum[11][4] = 1;
    $game_skill_text[11][4][1] = "[<b>{$target_name}</b>]&nbsp;<b>{$player_name} </b>наносил{$sex_a} <font class=atype>могучий </font> удар молотом {$po_mestu[$kickto]}, но {$target_name} <b>увернул{$las2} </b> от удара.";
}

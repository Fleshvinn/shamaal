...
<head>
	...
	<title>Shamaal : Last Citadel. : бесплатная браузерная онлайн игра.</title>
</head>
		...
		<table width=610 cellpadding=2 cellspacing=1 bgcolor="95A7AA">
			...
			<tr>
				...
				<td bgcolor="E7EEE5" align=right class="t2">
					...
					<td class=t2></td>
					<td align=right class=t2><a target="blank" href="/">Copyright &copy; 2022-<? print date("Y"); ?> by Shamaal</a></td>
					</tr></table>

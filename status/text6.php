<div align=center><b>Топ 30 по уровню </b></div><br>
<?php
...
$SQL="select name,city,level from sw_users where level and city <> 7 and npc =0 and (admin = 0 or (admin > 2 and admin < 7)) order by level DESC limit 0,30";
